...
| **G** | 沒有自動化測試、沒有 ESLint | 🟡 中 | 2-3 小時 | ✅ 已完成（2026-06-28 Session G + 2026-07-01 G4 lint gate）|
| **H** | 6 個重要模組沒有 unit test | 🟡 中 | 3-4 小時 | ⏳ 待執行 |
| **J** | sync-mirror 會誤刪主位置測試資料 | 🟢 低 | 1-2 小時 | ✅ 已完成（2026-06-29 4 改動 + 2026-07-01 regression test）|
