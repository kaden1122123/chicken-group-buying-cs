...
> 📎 **2026-06-27 整理說明**：本檔是 6/15 階段 1+2 的**詳細展開版**（8 項）。總覽（4 大類 11 項）見 [`REVIEW_2026-06-15_FOLLOWUP_PLAN.md`](./REVIEW_2026-06-15_FOLLOWUP_PLAN.md)。兩個檔案互補：總覽 + 詳細，未來清理時應一起評估。
